...
query_params = {'query': '#AI -is:quote -is:retweet -has:links -has:mentions lang:en', 'tweet.fields': 'author_id', 'max_results': 100}
...
def main():
    ...
    with open("tweet_data_AI.json", "w") as jfile:
